     ...
     <div class='container'>
         <div class='case'>
            ...
            <div class='case-details'>
                <p>Case Number: <span>" . $row['case_number'] . "</span></p>
                <p>Status: <span>" . $row['case_status'] . "</span></p>
                <p>Assigned Officer: <span>" . $row['jawaan_id'] . "</span></p>
                <p>Location: <span>" . $row['location'] . "</span></p>
                <p>Crime type: <span>" . $row['crime_type'] . "</span></p>
            </div>
...
";
    ...
    echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                var case_list = document.querySelector('.case-details');
                var case_report = document.querySelector('.main_content');
                var case_report_btn = document.querySelector('.submit');

                case_list.addEventListener('click', function() {
                    case_report.style.display = 'block';
                    case_list.style.display = 'none';
                });

                case_report_btn.addEventListener('click', function() {
                    case_report.style.display = 'none';
                    case_list.style.display = 'flex'; // Assuming you want to show the case list again
                });
            });
          </script>";
    // Close connection
