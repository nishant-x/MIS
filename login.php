...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_SESSION['captcha'] == $enteredCaptcha) {
        ...
        $stmt = $conn->prepare("SELECT * FROM jawaan_login WHERE jawaan_id=? AND jawaan_password=?");
        ...
        if ($num == 1) {
            ...
            header("location: jawan_home.php");
        } else {
        ...
        <div class="container">
            ...
            <div class="login_div rightdiv">
                ...
                <form action="#" method="POST">
                    ...
                    <!-- /////// -->
                    <h6><a href="forgot_jawan.php">Forgot password?</a></h6>
